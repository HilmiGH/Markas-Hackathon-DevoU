...
<div x-data="{ open: false }" class="">
    <section class="" style="padding-left: 5rem; padding-right: 5rem; padding-top: 4rem">
        <a href="{{ url('/booking') }}"
            style="border-radius: 24px; padding-block: 20px; padding-inline: 40px; background-color: white; border: 2px solid #000;">
            <svg class="inline-block mr-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
        ...
        <div style="display: flex; margin-top: 3rem; margin-bottom: 3rem ; justify-content: center">
            ...
            <svg class="inline-block ml-4 mr-10" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
    ...
    <section style="padding-left: 5rem; margin-top: 3rem; margin-bottom: 1rem; padding-right: 5rem;">
        <div class="mb-12 flex justify-center">
            <button>
                <svg class="inline-block mr-8" width="24" height="24" viewBox="0 0 14 23" fill="none"
            ...
            <button x-on:click="open = ! open; month = 'December'">
                <svg class="inline-block ml-8" width="24" height="24" viewBox="0 0 14 23" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
        ...
        <table x-show="!open" class="font-lexendMega w-full border-collapse rounded-[24px]">
            <tr class="bg-redMarkas" style="border-top-left-radius: 24px; border-top-right-radius: 24px;">
                <th class="border-2 rounded-tl-[24px] p-2 border-black"
                    style="color: rgb(255 255 255); padding-block: 26px; padding-inline: 47px">Minggu</th>
                <th class="border-2 p-2 border-black"
                    style="color: rgb(255 255 255); padding-block: 26px; padding-inline: 47px">Senin</th>
                <th class="border-2 p-2 border-black"
                    style="color: rgb(255 255 255); padding-block: 26px; padding-inline: 47px">Selasa</th>
                <th class="border-2 p-2 border-black"
                    style="color: rgb(255 255 255); padding-block: 26px; padding-inline: 47px">Rabu</th>
                <th class="border-2 p-2 border-black"
                    style="color: rgb(255 255 255); padding-block: 26px; padding-inline: 47px">Kamis</th>
                <th class="border-2 p-2 border-black"
                    style="color: rgb(255 255 255); padding-block: 26px; padding-inline: 47px">Jumat</th>
                <th class="border-2 p-2 border-black"
                    style="color: rgb(255 255 255); border-top-right-radius: 24px; padding-block: 26px; padding-inline: 47px">
                    Sabtu</th>
            </tr>
            ...
            <tr class="bg-white h-[8rem] border-black border-2">
                ...
                <td class="" style="border: 2px solid #000"><button class="w-full h-[8rem]">9
                        <svg class="mx-auto" width="30" height="30" viewBox="0 0 45 45" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
            ...
            <tr class="bg-white h-[8rem] border-black border-2"
                ...
                <td class="" style="border: 2px solid #000"><button class="w-full h-[8rem]"
                        style="border-bottom-left-radius: 24px">26</td>
                ...
                <td class="" style="border: 2px solid #000"><button class="w-full h-[8rem]">1</td>
                <td class="" style="border: 2px solid #000"><button class="w-full h-[8rem]"
                        style="border-bottom-right-radius: 24px">2</td>
            </tr>
        </table>
        <table x-show="open" class="font-lexendMega w-full border-collapse rounded-[24px]">
            <tr class="bg-redMarkas" style="border-top-left-radius: 24px; border-top-right-radius: 24px;">
            ...
            <tr class="bg-white border-black p-8"
                ...
                <table class=" w-[80rem]">
                    <tr class=" bg-white h-[3rem]" style="border: 2px solid #000">
                        ...
                        <th class="font-bold font-lexendMega border-black" style="border: 2px solid #000">Kegiatan
                        </th>
                    </tr>
                    ...
                    <tr class="border-black bg-white h-[3rem]" style="border: 2px solid #000">
                        <td class="border-black font-lexendMega" style="text-align: center; border: 2px solid #000">
                            16:00 - 18:00</td>
                        <td class="border-black font-lexendMega" style="text-align: center; border: 2px solid #000">
                            <svg class="inline-block mr-4" width="30" height="30" viewBox="0 0 45 45"
                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                <circle cx="22.5" cy="22.5" r="22.5" fill="#D90027" />
                            </svg>
                            Sekolah Beta Intensif Hipster
                        </td>
                    </tr>
                    <tr class="border-black bg-white h-[3rem]" style="border: 2px solid #000">
                        <td class="border-black font-lexendMega" style="text-align: center; border: 2px solid #000">
                    ...
                    <tr class="border-black bg-white h-[3rem]" style="border: 2px solid #000">
                        <td class="border-black font-lexendMega"
                            style="text-align: center; border-bottom-left-radius: 24px; border: 2px solid #000">23:00 -
                            23:30</td>
                        <td class="border-black font-lexendMega"
                            style="text-align: center; border-bottom-right-radius: 24px; border: 2px solid #000"><img
                                src="" alt=""></td>
                    </tr>
                </table>
            </tr>
        </table>
        <a href="{{ url('/checkout-form') }}" class="bg-redMarkas mt-8 float-right"
            style="border-radius: 24px; padding-block: 16px; padding-inline: 45px;">
