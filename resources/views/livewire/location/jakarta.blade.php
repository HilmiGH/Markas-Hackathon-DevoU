...
<div>
    <div class="mt-24">
        ...
        <h1 class="text-black font-extrabold text-5xl my-6">XYZ, JAKARTA</h1>
    ...
    <div class="mt-[969px]">
        <div class="">
            ...
            <div class="border-2 border-black w-full h-[381px] mt-[90px] rounded-[18px] pl-[30px] pb-[35px] pt-[22px]">
                ...
                <div class="flex flex-row gap-x-[44px]">
                    ...
                    <div>
                        ...
                        <p class="text-base text-redMarkas mt-[20px]">Kapasitas Maksimal: <span class="text-black">50
                                orang</span></p>
                    </div>
